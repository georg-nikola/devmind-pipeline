...
model_accuracy = Gauge(
    "devmind_model_accuracy", "Current model accuracy", ["model_name"]
)

model_training_duration = Histogram(
    "devmind_model_training_duration_seconds", "Model training duration", ["model_name"]
)
...
def setup_monitoring() -> None:
    ...
    app_info.info(
        {"version": "1.0.0", "environment": "production", "service": "devmind-pipeline"}
    )
...
def record_prediction(
    model_name: str, duration: float, status: str = "success"
) -> None:
